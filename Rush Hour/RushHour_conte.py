...
def iterative_deepening_DFS(state, current_depth, max_depth, visited_states):
    ...
    if solved_state(state): #found goal state
        #print("ID searched states: ", len(visited_states))
        Number_of_searched_states = len(visited_states) + 1
    ...
    for x in range(len(child_states)):
        ...
        if Goal_state is not None: #found goal state going down that child
            #print("ID searched states: ", len(visited_states))
            Number_of_searched_states = len(visited_states)
...
def RRHC(initial_state, visiable_states):
    ...
    if solved_state(initial_state):
        ...
        Number_of_searched_states = Number_of_searched_states + len(visited_states) + 1
...
class Rush_Hour():
        ...
        while len(self.BSF_Queue) != 0:
            ...
            if solved_state(current_state):
                if Num_of_goal_states == 0:
                    ...
                    end_time = time.time()
                    #print("BSF Time: ", end_time-start_time)
                    print("BSF Searched states: ", len(self.visited))
    ...
    def iterative_deepening(self):
        ...
        while not bottom_reached:
            ...
            if goal_state is not None:
                ...
                end_time = time.time()
                #print("ID Time: ", end_time-start_time)
                print("ID Searched states: ", Number_of_searched_states)
                return None
            depth = depth + 1
    ...
    def A_Star(self, Number_of_Heuristics):
        ...
        while len(self.A_Star_Queue) > 0:
            ...
            if solved_state(current_state):
                ...
                print("A* Searched states: ", len(self.visited) + 1)
                return True
    ...
    def Simple_Hill_Climbing(self):
        ...
        if solved_state(self.start_state):
                ...
                end_time = time.time()
                #print("SHC Time: ", end_time-start_time)
                print("SHC searched states: ", len(visited_states) + 1)
                return True
        ...
        end_time = time.time()
        #print("SHC Time: ", end_time-start_time)
        print("SHC searched states: ", len(visited_states))
        #print_game_map(best_state.map)
        #print(best_state.path)
        return False
    ...
    def Steepest_Ascent_Hill_Climbing(self):
        ...
        if solved_state(self.start_state):
                ...
                end_time = time.time()
                #print("SAHC Time: ", end_time-start_time)
                print("SAHC searched states: ", len(visited_states) + 1)
                return True
        ...
        end_time = time.time()
        #print("SAHC Time: ", end_time-start_time)
        print("SAHC searched states: ", len(visited_states))
        #print_game_map(best_state.map)
        #print(best_state.path)
        return False
    ...
    def Stochastic_Hill_Climbing(self):
        ...
        if solved_state(self.start_state):
                ...
                end_time = time.time()
                #print("SCHC Time: ", end_time-start_time)
                print("SCHC searched states: ", len(visited_states) + 1)
                return True
    ...
    def Random_Restart_Hill_Climbing(self):
        ...
        end_time = time.time()
        #print("RRHC Time: ", end_time-start_time)
        print("RRHC searched states s: ", Number_of_searched_states)
        return True
...
#game start
game_num = 35
while game_num < len(RH_game_data): #for game_num in range(len(RH_game_data)):
    print("Problem ", game_num + 1)
    #if game_num == 1 or game_num == 10: #BFS getting stuck with these puzzles
        #game_num = game_num + 1
        #continue
